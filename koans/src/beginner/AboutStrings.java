...
public class AboutStrings {
    ...
    public void stringBuilderCanActAsAMutableString() {
        String str = "one two";
        assertEquals(new StringBuilder("one").append(" ").append("two").toString(), str);
    }

    @Koan
    public void readableStringFormattingWithStringFormat() {
        String str = "a b a";
        assertEquals(String.format("%s %s %s", "a", "b", "a"), str);
    }

    @Koan
    public void extraArgumentsToStringFormatGetIgnored() {
        String str = "a b c";
        assertEquals(String.format("%s %s %s", "a", "b", "c", "d"), str);
    }
